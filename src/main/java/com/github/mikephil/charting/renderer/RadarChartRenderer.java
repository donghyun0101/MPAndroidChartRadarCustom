...
public class RadarChartRenderer extends LineRadarRenderer {
    ...
    public void drawBackground(Canvas c) {
        ...
        paint.setStrokeWidth(mChart.getWebLineWidthInner());
//        Log.e("Error", String.valueOf(mChart.getWebLineWidthInner()));

        float sliceangle = mChart.getSliceAngle();
//        Log.e("sliceangle", String.valueOf(sliceangle));
        // calculate the factor that is needed for transforming the value to
        // pixels
        float factor = mChart.getFactor();
        float rotationangle = mChart.getRotationAngle();
//        Log.e("factor", String.valueOf(factor));
//        Log.e("rotationangle", String.valueOf(rotationangle));
...
//        Log.e(" . ", " . ");
        ...
        Utils.getPosition(center, r, sliceangle * 0 + rotationangle, p2out);
        path.moveTo(p2out.x, p2out.y);

        for (int i = 0; i < mChart.getData().getEntryCount(); i++) {
            Utils.getPosition(center, r, sliceangle * i + rotationangle, p2out);

//            Log.e("tag " + i, p2out.x + ", " + p2out.y);
            path.lineTo(p2out.x, p2out.y);
        }
